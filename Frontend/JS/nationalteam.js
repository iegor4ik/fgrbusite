...
const teams = {
	...
	u20: {
		...
		worldAthletes: [
				...
				{ id: 'u20-world-athlete-4', role: 'Спортсмен', name: 'Кирило Угрік', image: 'assets/u20/World/Кирилло Угрік.webp', dob: '', city: '', title: 'Склад світу', weight: '82 кг', achievements: [] },
				{ id: 'u20-world-athlete-5', role: 'Спортсмен', name: 'Нестор Баран', image: 'assets/u20/World/Нестор Баран.webp', dob: '', city: '', title: 'Склад світу', weight: '77 кг', achievements: [] },
				...
				{ id: 'u20-world-athlete-7', role: 'Спортсмен', name: 'Денис Ковшун', image: 'assets/u20/World/Ковшун.webp', dob: '', city: '', title: 'Склад світу', weight: '67 кг', achievements: [] },
				...
				{ id: 'u20-world-athlete-9', role: 'Спортсмен', name: 'Назар Бабінський', image: 'assets/u20/World/Назар Бабінський.webp', dob: '', city: '', title: 'Склад світу', weight: '60 кг', achievements: [] },
