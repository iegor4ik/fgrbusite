...
const presidiumMembers = [
  ...
  // ========================================================================
  {
    ...
    city: 'Харків',
    appointed: '2023',
    description: 'Координує роботу всіх структурних підрозділів федерації. Забезпечує взаємодію з органами державної влади, відомствами та міжнародними спортивними організаціями. Організує міжнародні змагання та укладає угоди про співробітництво.',
  },
